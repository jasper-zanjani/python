...
The true decorator pattern appears here, where **wrapper** is the decorator and **outer** has been "decorated".
...
Inspecting the decorated function's **\_\_name\_\_** attribute reveals that it is still named **\_wrapper**.
